...
const TryOnFeature = () => {
  ...
  const outfits = [
    "/images/cloth2.jpg",
    "/images/cloth5.jpeg",
    "/images/cloth6.webp", // Add another outfit for better selection
  ];
      ...
      <div className="outfit-options mt-6 flex justify-center space-x-6">
        {outfits.map((outfit, index) => (
          <button
            ...
            className="p-2 border-2 border-white rounded-md hover:bg-white hover:text-rose-500 hover:border-rose-500 transform transition-all duration-300 ease-in-out focus:outline-none"
          >
            <Image
              src={outfit}
              alt={`Outfit ${index + 1}`}
