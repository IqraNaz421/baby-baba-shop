...
const Hero: React.FC = () => {
  return (
    <section 
      ...
      style={{ backgroundImage: 'url(https://www.shutterstock.com/image-photo/children-clothing-store-600nw-376538977.jpg)' }}
    >
      {/* Gradient Overlay */}
      ...
      <div className="absolute bottom-0 left-0 w-full bg-gradient-to-r from-rose-500 to-rose-400 p-3 sm:p-4 text-center text-white font-bold overflow-hidden">
