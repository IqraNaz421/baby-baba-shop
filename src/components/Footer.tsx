...
const Footer: React.FC = () => {
  return (
    <footer className="bg-rose-100 text-white py-12 px-4 sm:px-6 lg:px-12">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <Link href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="bg-white text-rose-600 p-3 rounded-full hover:bg-gray-200 transition duration-300">
              <FaFacebookF />
            </Link>
            <Link href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="bg-white text-rose-600 p-3 rounded-full hover:bg-gray-200 transition duration-300">
              <FaTwitter />
            </Link>
            <Link href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="bg-white text-rose-600 p-3 rounded-full hover:bg-gray-200 transition duration-300">
              <FaInstagram />
            </Link>
            <Link  href="https://linkedin.com" rel="noopener noreferrer" className="bg-white text-rose-600 p-3 rounded-full hover:bg-gray-200 transition duration-300">
              <FaLinkedinIn />
            </Link>
          </div>
        </div>
      ...
      <div className="text-center text-gray-800 mt-12">
        ...
        <p>
          Designed by <span className='text-rose-600'>Iqra Naz</span> 
        </p>
      </div>
    </footer>
  );
