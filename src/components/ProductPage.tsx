        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="product-info">
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4">
                ...
                <button
                  ...
                  className={`w-8 h-8 rounded-full ${selectedColor === 'pink' ? 'border-4 border-pink-400' : 'bg-pink-300'}`}
                />
                <button
                  onClick={() => setSelectedColor("green")}
                  className={`w-8 h-8 rounded-full ${selectedColor === 'green' ? 'border-4 border-green-500' : 'bg-green-400'}`}
                />
              </div>
            ...
            <button
              ...
              className="mt-6 py-2 px-4 bg-rose-500 text-white rounded-lg w-6/12 hover:bg-rose-600 transition"
            >
              Add to Cart
            </button>

            {inCart && (
              <div className="popup mt-4 text-center text-lg font-semibold text-green-500">
            ...
            {showReviewForm && (
              <div className="mt-4">
                ...
                <button 
                  ...
                  className="mt-2 py-2 px-4 bg-rose-500 text-white rounded-lg hover:bg-rose-600 transition"
                >
                  Submit Review
                </button>
              </div>
