        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-pink-200">
              ...
              {[...Array(5)].map((_, i) => (
                <FaStar
                  ...
                  className={`cursor-pointer transition-colors duration-200 ${
                    (hover || rating) > i ? 'text-rose-500' : 'text-gray-300'
                  }`}
            ...
            <button
              ...
              className="mt-4 w-full bg-rose-500 hover:bg-rose-600 text-white py-2 px-4 rounded-lg transition-colors duration-300"
            >
              Submit Feedback
            </button>
            {submitted && (
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-rose-200">
            ...
            <button
              ...
              className="w-full bg-rose-500 hover:bg-rose-600 text-white py-2 px-4 rounded-lg transition-colors duration-300"
            >
              Send Message
            </button>
          </div>
