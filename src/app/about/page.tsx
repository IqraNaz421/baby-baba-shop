    ...
    <section className="bg-gray-100 py-16 px-6">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <h3 className="text-2xl font-semibold text-rose-500 mb-4">Our Story</h3>
        ...
        {/* Core Values */}
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <h3 className="text-2xl font-semibold text-rose-500 mb-4">Our Core Values</h3>
        ...
        {/* Team Members */}
        <div className="text-center mb-12">
          <h3 className="text-3xl font-semibold text-rose-600 mb-6">Meet the Team</h3>
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 w-60">
              ...
              <h4 className="text-xl font-semibold text-rose-500">Alice Smith</h4>
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 w-60">
              ...
              <h4 className="text-xl font-semibold text-rose-500">John Doe</h4>
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 w-60">
              ...
              <h4 className="text-xl font-semibold text-rose-500">Emily Johnson</h4>
        ...
        <div className="text-center mt-12">
          <h3 className="text-2xl font-semibold text-rose-500 mb-4">Join Our Journey</h3>
          ...
          <a href="/contact" className="bg-rose-500 hover:bg-rose-600 text-white py-3 px-6 rounded-lg transition-colors duration-300">
            Contact Us
          </a>
        </div>
      </div>
